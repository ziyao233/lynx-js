...
CFLAGS		= -O2  
DEFS		= -DHAVE_CONFIG_H
CPPFLAGS	= -D_LARGE_FILES -D_POSIX_C_SOURCE=199506L -DLINUX -D_GNU_SOURCE -D_XOPEN_SOURCE_EXTENDED
LINT		= 
ETAGS		= 
EGREP		= /bin/grep -E
FGREP		= /bin/grep -F
...
LDFLAGS		= -Wl,-rpath,/usr/lib/quickjs   -L/lib -L/usr/lib/quickjs
LIBS		=  -lquickjs -lncurses
...
actual_PROG  = `echo lynx|sed 's,x,x,'`
...
LYNX_URL='https://lynx.invisible-island.net/release/breakout'
LYNXDOCS_URL='$(LYNX_URL)/docs/'
LYNXHELP_URL='$(LYNX_URL)/lynx_help/'

htmlized_cfg:
##htmlized_cfg: $(CFG2HTML)
##$(CFG2HTML):
#.PHONY: htmlized_cfg
#$(CFG2HTML): htmlized_cfg
#htmlized_cfg:
